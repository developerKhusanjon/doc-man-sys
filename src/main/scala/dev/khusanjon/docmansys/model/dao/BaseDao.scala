package dev.khusanjon.docmansys.model.dao

import dev.khusanjon.docmansys.conf.DatabaseConfig
import dev.khusanjon.docmansys.model.db.{CompanyTable, EmployeeTable, FieldValueTable, FormFieldTable, FormSubmissionTable, WebFormTable}
